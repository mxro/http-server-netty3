...
public class TestThatShutdownServerWorks {
  ...
  public void test() {
    try {
      ...
      boolean _string = TestThatShutdownServerWorks.getString(is);
      InputOutput.<Boolean>println(Boolean.valueOf(_string));
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
  
  public static boolean getString(final InputStream is) {
